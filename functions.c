...
static void FUNCTION_Foreground(FUNCTION_Type_t PreviousFunction);
static void FUNCTION_PowerSave();
static void FUNCTION_Transmit();
...
static void FUNCTION_Foreground(const FUNCTION_Type_t PreviousFunction)
{
#ifdef ENABLE_DTMF_CALLING
